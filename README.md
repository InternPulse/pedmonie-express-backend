...
1. Clone the repo `git clone https://github.com/InternPulse/pedmonie-express-backend.git`.
2. Open your terminal & set the origin branch: `git remote add origin https://github.com/InternPulse/pedmonie-express-backend.git`
